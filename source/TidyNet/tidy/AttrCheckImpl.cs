...
namespace TidyNet
{
	...
	internal class AttrCheckImpl
	{
		public static IAttrCheck CheckUrl
		{
			get
			{
				return _checkUrl;
		...
		public static IAttrCheck CheckScript
		{
			get
			{
				return _checkScript;
		...
		public static IAttrCheck CheckAlign
		{
			get
			{
				return _checkAlign;
		...
		public static IAttrCheck CheckValign
		{
			get
			{
				return _checkValign;
		...
		public static IAttrCheck CheckBool
		{
			get
			{
				return _checkBool;
		...
		public static IAttrCheck CheckId
		{
			get
			{
				return _checkId;
		...
		public static IAttrCheck CheckName
		{
			get
			{
				return _checkName;
		...
		private static IAttrCheck _checkUrl = new UrlAttrCheck();
		private static IAttrCheck _checkScript = new ScriptAttrCheck();
		private static IAttrCheck _checkAlign = new AlignAttrCheck();
		private static IAttrCheck _checkValign = new ValignAttrCheck();
		private static IAttrCheck _checkBool = new BoolAttrCheck();
		private static IAttrCheck _checkId = new IdAttrCheck();
		private static IAttrCheck _checkName = new NameAttrCheck();
	}
}